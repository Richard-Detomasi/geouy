...
metadata <- tibble::tribble(
  ...
  "Secciones11", "INE", "MIDES", 32721, "wfs", 2011, "https://mapas.mides.gub.uy/geoserver/INECenso2011/wfs?SERVICE=WFS&REQUEST=GetFeature&VERSION=1.0.0&TYPENAMES=INECenso2011:secciones_2011", "CODSEC","SECCION", "UTF-8",
  "Segmentos11", "INE", "MIDES", 32721, "wfs", 2011, "https://mapas.mides.gub.uy/geoserver/INECenso2011/wfs?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&TYPENAMES=INECenso2011:segmentos_2011", "CODSEG","SEGMENTO", "UTF-8",
  "Zonas11", "INE", "MIDES", 32721, "wfs", 2011, "https://mapas.mides.gub.uy/geoserver/INECenso2011/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2011:Zona_2011", "CODCOMP","ZONA", "UTF-8",
