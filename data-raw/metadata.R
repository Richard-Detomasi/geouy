...
metadata <- tibble::tribble(
  ...
  "Areas administrativas", "SGM", "IGM", 4326, "wfs", 2011, "https://srvgis.igm.gub.uy/arcgis/services/Limites/Millon/MapServer/WFSServer?service=WFS&version=2.0.0&request=GetFeature&typeName=Millon:AreaAdministrativa", NA, NA, "UTF-8",
  ...
  "Limites departamentales", "IGM", "IGM", 4326, "wfs", 2011, "https://srvgis.igm.gub.uy/arcgis/services/Limites/LimiteDepartamental250/MapServer/WFSServer?service=WFS&version=2.0.0&request=GetFeature&typeName=LimiteDepartamental250:LimitesDepartamentales", "globalid", "depto", "UTF-8",
  ...
  "Secciones", "INE", "MIDES", 32721, "wfs", 2023, "https://mapas.mides.gub.uy:443/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso:Secciones", "CODSEC","SECCION", "UTF-8",
  ...
  "Segmentos", "INE", "MIDES", 32721, "wfs", 2023, "https://mapas.mides.gub.uy/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso:Segmentos", "CODSEG","SEGMENTO", "UTF-8",
  ...
  "Zonas", "INE", "MIDES", 32721, "wfs", 2023, "https://mapas.mides.gub.uy/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso:Zonas", "CODCOMP","ZONA", "UTF-8",
  "Secciones11", "INE", "MIDES", 32721, "wfs", 2011, "https://mapas.mides.gub.uy/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2011:secciones_2011&outputFormat=application/json", "codsec","seccion", "UTF-8",
  "Segmentos11", "INE", "MIDES", 32721, "wfs", 2011, "https://mapas.mides.gub.uy/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2011:segmentos_2011&outputFormat=application/json", "codseg","segmento", "UTF-8",
  "Zonas11", "INE", "MIDES", 32721, "wfs", 2011, "https://mapas.mides.gub.uy/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso2011:zona_2011&outputFormat=application/json", "codcomp","zona", "UTF-8",
  ...
  "Localidades pg", "INE", "MIDES", 32721, "wfs", 2023, "https://mapas.mides.gub.uy:443/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso:Localidades_pg", "CODLOC","NOMBLOC", "UTF-8",
  "Localidades pt", "INE", "MIDES", 32721, "zip", 2023, "https://mapas.mides.gub.uy/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=INECenso:Localidades_pt&outputFormat=SHAPE-ZIP", "CODLOC","NOMLOC", "UTF-8",
  ...
  "SeccHog11", "INE", "IDE", 32721, "zip", 2011, "https://mapas.ide.uy/geoserver-vectorial/INE_NO_SEGURO/wfs?service=WFS&request=GetFeature&version=1.0.0&outputFormat=shape-zip&typeName=secc_hog11", "codsec", NA, "WINDOWS-1252", 
  "SeccPob11", "INE", "IDE", 32721, "zip", 2011, "https://mapas.ide.uy/geoserver-vectorial/INE_NO_SEGURO/wfs?service=WFS&request=GetFeature&version=1.0.0&outputFormat=shape-zip&typeName=secc_pob11", "codsec", NA, "WINDOWS-1252",  
  "SeccPobHom11", "INE", "IDE", 32721, "zip", 2011, "https://mapas.ide.uy/geoserver-vectorial/INE_NO_SEGURO/wfs?service=WFS&request=GetFeature&version=1.0.0&outputFormat=shape-zip&typeName=secc_pob_hom", "codsec", NA, "WINDOWS-1252",  
  "SeccPobMuj11", "INE", "IDE", 32721, "zip", 2011, "https://mapas.ide.uy/geoserver-vectorial/INE_NO_SEGURO/wfs?service=WFS&request=GetFeature&version=1.0.0&outputFormat=shape-zip&typeName=secc_pob_muj", "codsec", NA, "WINDOWS-1252",  
  "SeccViv11", "INE", "IDE", 32721, "zip", 2011, "https://mapas.ide.uy/geoserver-vectorial/INE_NO_SEGURO/wfs?service=WFS&request=GetFeature&version=1.0.0&outputFormat=shape-zip&typeName=secc_viv11", "codsec", NA, "WINDOWS-1252",  
  ...
  "Centros poblados pg", "SGM", "IGM", 4326, "wfs", 2011, "https://srvgis.igm.gub.uy/arcgis/services/Limites/Millon/MapServer/WFSServer?service=WFS&version=2.0.0&request=GetFeature&typeName=Millon:Ciudades", "gml_id", "nam", "UTF-8",
  "Centros poblados pt", "SGM", "IGM", 4326, "wfs", 2011, "https://srvgis.igm.gub.uy/arcgis/services/Limites/Millon/MapServer/WFSServer?service=WFS&version=2.0.0&request=GetFeature&typeName=Millon:Centros_poblados", "gml_id", "nam", "UTF-8",
  "Municipios", "IGM", "IGM", 4326, "wfs", 2011, "https://srvgis.igm.gub.uy/arcgis/services/Limites/Limites_Municipales_250mil/MapServer/WFSServer?service=WFS&version=2.0.0&request=GetFeature&typeName=Limites_Municipales_250mil:LimitesMunicipales", "OBJECTID", "nombre", "UTF-8",
  "Municipios10", "DINOT-IM-IC", "MVOTMA", 32721, "zip", 2010, "https://sit.mvot.gub.uy/shp/Municipios2010.zip", "OBJECTID", "MUNICIPIO", "UTF-8",
  "Municipios15", "DINOT-IM-IC", "MVOTMA", 32721, "zip", 2015, "https://sit.mvot.gub.uy/shp/Municipios2015.zip", "OBJECTID", "MUNICIPIO", "UTF-8",
